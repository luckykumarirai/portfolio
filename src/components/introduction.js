    ...
    <Grid container className={classes.root} direction="row" justify="flex-start">
        ...
        <Grid item xs={12} sm={6} className={classes.intro}>
            ...
            <Grid xs={12} sm={3} style={{display:'flex'}}>
              ...
              <Link href="https://github.com/luckykumarirai" target="_blank"><Avatar style={{marginRight:10 }} alt="i am programmer" src={process.env.PUBLIC_URL +"/images/github.png" }/></Link>
              <Link href="https://www.linkedin.com/in/luckykumarirai/" target="_blank"><Avatar style={{marginRight:10 }} alt="i am programmer" src={process.env.PUBLIC_URL +"/images/li.jpg"} /></Link>
              <Link href="https://www.facebook.com/profile.php?id=100027989108049" target="_blank"><Avatar  style={{marginRight:10 }} alt="i am programmer" src={process.env.PUBLIC_URL +"/images/facebook.png" }/></Link>
              <Link href="#" target="_blank"><Avatar  style={{marginRight:20 }}alt="i am programmer" src={process.env.PUBLIC_URL +"/images/telegram1.png"} /></Link>
              </Grid>
